        ...
        <div className="mb-6">
          ...
          <div className="space-y-1">
            {Object.keys(files).map(filename => (
              <div 
                key={filename} 
                className={`flex items-center justify-between group px-3 py-1.5 rounded text-sm font-medium transition-colors ${activeFile === filename ? 'bg-blue-600/20 text-blue-400 border border-blue-600/30' : 'text-gray-400 hover:bg-gray-700 hover:text-white border border-transparent'}`}
              >
                <button
